...
const contentimg = document.querySelector(
  ".slider .content-wrap .content-img img"
);
const contentTitle = document.querySelector(".slider .content-wrap h3");
const contentInfo = document.querySelector(".slider .content-wrap p");

const prevArrow = document.querySelector(".slider .arrows .prev-arrow");
const nextArrow = document.querySelector(".slider .arrows .next-arrow");

const doorLift = document.querySelector(".slider .content-wrap .door-left");
const doorRight = document.querySelector(".slider .content-wrap .door-right");
